...
describe User do
  ...
  it "should create a new instance given valid attributes", :chapter6 => "true", :chapter7 => "true" do
    User.create!(@attr)
  end
  ...
  it "should reject invaild email addresses", :chapter6 => "true" do
  ...
  describe "password encryption" do
    ...
    describe "authentication method", :chapter7 => "true" do
